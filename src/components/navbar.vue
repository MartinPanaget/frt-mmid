    ...
    <div>
        <svg id="navbar" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 237.28 1081.99">
            ...
            <g id="hover-country-page" :class="{active: acceptanceA}">
                <line id="Linie_257-2-6" data-name="Linie 257-2" class="cls-1-text" x1="58.4" y1="446.31" x2="164.77" y2="446.31"/>
                <g>
            ...
            <g id="hover-attribute-page" :class="{active: acceptanceB}">
                <line id="Linie_257-2-7" data-name="Linie 257-2" class="cls-1-text" x1="72.81" y1="560.74" x2="178.72" y2="560.74"/>
                <g>
