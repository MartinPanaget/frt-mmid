<template>
    <div>
        <svg id="navbar" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 237.28 1081.99">
            <g id="hover-home" :class="{active: start}" >
                <line id="Linie_257-2" data-name="Linie 257-2" class="cls-1-text" x1="116.8" y1="81.29" x2="164.38" y2="81.29"/>
                <g>
            ...
            <g id="hover-imprint"  :class="{active: imprint}">
                <line id="Linie_257-2-2" data-name="Linie 257-2" class="cls-1-text" x1="57.08" y1="656.68" x2="121.62" y2="656.68"/>
                <g>
            ...
            <g id="hover-info-page"  :class="{active: info}">
                <line id="Linie_257-2-3" data-name="Linie 257-2" class="cls-1-text" x1="127.5" y1="174.88" x2="169.7" y2="174.88"/>
                <g>
            ...
            <g id="hover-Lollipop-page"  :class="{active: riskandbenefits}">
                <line id="Linie_257-2-4" data-name="Linie 257-2" class="cls-1-text" x1="100.44" y1="263.28" x2="237.28" y2="263.28"/>
                <g>
            ...
            <g id="hover-bubble-page"  :class="{active: occurances}">
                <line id="Linie_257-2-5" data-name="Linie 257-2" class="cls-1-text" x1="94.72" y1="361.96" x2="185.19" y2="361.96"/>
                <g>
            ...
            <g id="hover-country-page" :class="{active: acceptanceA}">
                <line id="Linie_257-2-6" data-name="Linie 257-2" class="cls-1-text" x1="58.4" y1="446.31" x2="180.22" y2="446.31"/>
                <g>
                    <path class="cls-2" d="M72.14,426.3v6.11h3.69v1.48H72.14v8.27H70.53V424.82H76v1.48Z" transform="translate(0 -0.01)"/>
                    <path class="cls-2" d="M84.1,442.16l-4-8.48v8.48H78.3V424.82h2.19a6.22,6.22,0,0,1,3,.49c1.56.83,1.87,2.55,1.87,4.16,0,2.4-.81,4.16-3.43,4.37l4,8.32Zm-3-9.75c2.08,0,2.41-1.22,2.41-3,0-2-.41-3.07-2.62-3.07h-.86v6.11Z" transform="translate(0 -0.01)"/>
                    <path class="cls-2" d="M90.24,426.3v15.86H88.62V426.3H86v-1.48h6.81v1.48Z" transform="translate(0 -0.01)"/>
                    <path class="cls-2" d="M105.65,442.16,105,438.6h-3.66l-.65,3.56H99l3.43-17.34h1.51l3.46,17.34Zm-2.05-11.07a29.64,29.64,0,0,1-.49-4.09,97.58,97.58,0,0,1-1.51,10.2h3.14Z" transform="translate(0 -0.01)"/>
                    <path class="cls-2" d="M113.27,441.75a2.85,2.85,0,0,1-1.66.59c-2.73,0-3.36-3.71-3.36-5.79s.47-6.19,3.44-6.19a3.12,3.12,0,0,1,1.58.44v1.72a2.07,2.07,0,0,0-1.45-.81c-1.85,0-2,3.41-2,4.71s.23,4.55,2,4.55a2,2,0,0,0,1.48-1Z" transform="translate(0 -0.01)"/>
                    <path class="cls-2" d="M119.67,441.75a2.85,2.85,0,0,1-1.67.59c-2.73,0-3.35-3.71-3.35-5.79s.47-6.19,3.43-6.19a3.15,3.15,0,0,1,1.59.44v1.72a2.07,2.07,0,0,0-1.46-.81c-1.84,0-2,3.41-2,4.71s.24,4.55,2,4.55a2,2,0,0,0,1.48-1Z" transform="translate(0 -0.01)"/>
                    <path class="cls-2" d="M127.36,438.21c-.07,1.87-.65,4.13-2.94,4.13-3,0-3.38-3.71-3.38-5.95s.45-6,3.28-6,3.15,3.51,3.15,5.56c0,.24,0,.5,0,.73h-4.91v.26c0,1.17.18,4.06,1.84,4.06,1.3,0,1.48-1.77,1.51-2.76ZM126,435.4c-.05-1-.18-3.69-1.66-3.69s-1.75,2.63-1.8,3.69Z" transform="translate(0 -0.01)"/>
                    <path class="cls-2" d="M131.08,431.32a2.1,2.1,0,0,1,1.85-1c2.86,0,2.88,3.66,2.88,5.77,0,2.5-.08,6.21-2.73,6.21a2.44,2.44,0,0,1-2-1.11v5.61h-1.46v-16.3h1.46Zm1.51.21c-1.51,0-1.64,2.44-1.64,4.76,0,1,0,3.74.73,4.47a1.16,1.16,0,0,0,.93.39c1.36,0,1.51-1.67,1.62-2.68s.07-1.82.07-2.73C134.3,434.57,134.28,431.53,132.59,431.53Z" transform="translate(0 -0.01)"/>
                    <path class="cls-2" d="M139.87,431.89v10.27h-1.46V431.89h-1.25v-1.35h1.25v-3.3h1.46v3.3h1.95v1.35Z" transform="translate(0 -0.01)"/>
                    <path class="cls-2" d="M147.56,442.16v-.93a2.28,2.28,0,0,1-2,1.11c-2.65,0-2.73-3.71-2.73-5.77,0-2.36.08-6.21,2.86-6.21a2.13,2.13,0,0,1,1.84,1v-.78h1.49v11.62Zm-1.48-10.63c-1.69,0-1.71,3-1.71,4.13,0,1,0,1.87.07,2.81s.26,2.68,1.62,2.68a1.16,1.16,0,0,0,.93-.39c.73-.73.73-3.46.73-4.47C147.72,434,147.59,431.53,146.08,431.53Z" transform="ttranslate(0 -0.01)"/>
                    <path class="cls-2" d="M156.17,442.16v-8.45c0-.93,0-2.16-1.3-2.16a1.64,1.64,0,0,0-1.38.76,3.6,3.6,0,0,0-.39,2v7.82h-1.45V430.54h1.45v.93a3.05,3.05,0,0,1,2.26-1.11c1.95,0,2.27,1.61,2.27,3.2v8.6Z" transform="translate(0 -0.01)"/>
                    <path class="cls-2" d="M164.8,441.75a2.85,2.85,0,0,1-1.66.59c-2.73,0-3.36-3.71-3.36-5.79s.47-6.19,3.44-6.19a3.12,3.12,0,0,1,1.58.44v1.72a2.07,2.07,0,0,0-1.45-.81c-1.85,0-2,3.41-2,4.71s.23,4.55,2,4.55a2,2,0,0,0,1.48-1Z" transform="translate(0 -0.01)"/>
                    <path class="cls-2" d="M172.5,438.21c-.08,1.87-.65,4.13-2.94,4.13-3,0-3.38-3.71-3.38-5.95s.44-6,3.28-6,3.14,3.51,3.14,5.56c0,.24,0,.5,0,.73h-4.92v.26c0,1.17.18,4.06,1.85,4.06,1.3,0,1.48-1.77,1.51-2.76Zm-1.35-2.81c-.06-1-.19-3.69-1.67-3.69s-1.74,2.63-1.79,3.69Z" transform="translate(0 -0.01)"/>
                </g>
            </g>
            <g id="hover-attribute-page" :class="{active: acceptanceB}">
                <line id="Linie_257-2-7" data-name="Linie 257-2" class="cls-1-text" x1="72.81" y1="560.74" x2="218.72" y2="560.74"/>
                <g>
                    ...
                    <path class="cls-2" d="M167.12,540.73v6.11h3.69v1.49h-3.69v8.27h-1.61V539.25H171v1.48Z" transform="translate(0 -0.01)"/>
                    <path class="cls-2" d="M177.34,556.6v-.94a2.3,2.3,0,0,1-2,1.12c-2.65,0-2.73-3.72-2.73-5.78,0-2.36.08-6.21,2.86-6.21a2.15,2.15,0,0,1,1.85,1V545h1.48V556.6ZM175.86,546c-1.69,0-1.72,3-1.72,4.14,0,1,0,1.87.08,2.8s.26,2.68,1.61,2.68a1.16,1.16,0,0,0,.94-.39c.72-.73.72-3.46.72-4.47C177.49,548.4,177.36,546,175.86,546Z" transform="translate(0 -0.01)"/>
                    <path class="cls-2" d="M186,556.18a2.89,2.89,0,0,1-1.67.6c-2.73,0-3.35-3.72-3.35-5.8s.47-6.19,3.43-6.19a3.26,3.26,0,0,1,1.59.44V547a2.07,2.07,0,0,0-1.46-.81c-1.85,0-2,3.41-2,4.71s.24,4.55,2,4.55a2,2,0,0,0,1.49-1Z" transform="translate(0 -0.01)"/>
                    <path class="cls-2" d="M189.71,546.32V556.6h-1.45V546.32H187V545h1.25v-3.3h1.45V545h1.95v1.35Z" transform="translate(0 -0.01)"/>
                    <path class="cls-2" d="M195.93,556.78c-3,0-3.41-3.75-3.41-6s.42-6,3.41-6,3.25,3.82,3.25,6.06S198.92,556.78,195.93,556.78Zm0-10.64c-1.79,0-1.84,3.54-1.84,4.76s.07,4.5,1.84,4.5,1.77-3.46,1.77-4.63S197.62,546.14,195.9,546.14Z" transform="translate(0 -0.01)"/>
                    <path class="cls-2" d="M204.79,546.48c-1.95,0-2,1.56-2,3.07v7.05h-1.46V545h1.46v1.51a2.4,2.4,0,0,1,2-1.69Z" transform="translate(0 -0.01)"/>
                    <path class="cls-2" d="M210.83,547.34a2.74,2.74,0,0,0-2-1.2,1.45,1.45,0,0,0-1.43,1.54c0,2.26,3.75,2.67,3.75,5.82a3.14,3.14,0,0,1-3.12,3.28,3.48,3.48,0,0,1-2.16-.81v-1.71a3,3,0,0,0,2,1.14,1.7,1.7,0,0,0,1.69-1.8c0-2.28-3.74-3.06-3.74-5.87a2.81,2.81,0,0,1,2.89-2.94,3.53,3.53,0,0,1,2.08.75Z" transform="translate(0 -0.01)"/>
                </g>
            </g>
...
#hover-attribute-page, #hover-country-page, 
#hover-bubble-page, #hover-Lollipop-page, 
#hover-info-page, #hover-imprint, #hover-home{
    opacity: 0;
...
#hover-attribute-page.active, #hover-country-page.active, 
#hover-bubble-page.active, #hover-Lollipop-page.active, 
#hover-info-page.active, #hover-imprint.active, #hover-home.active{
    opacity: 1;
}
